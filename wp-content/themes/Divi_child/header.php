	...
	<script type="text/javascript">
	    window.addeventasync = function () {
	        addeventatc.settings({
	            license: "ajZtgCpeXzixtOfQomxR83470",
					...
					<?php if ( ! $et_slide_header || is_customize_preview() ) : ?>
						...
						<?php
							...
							<ul id="top-menu" class="nav">
								<li id="menu-item-22" class="menu-button menu-item menu-item-type-custom menu-item-object-custom menu-item-22">
								<!-- 	<svg version="1.1" id="calendar_today-24px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
										 x="0px" y="0px" viewBox="0 0 24 24" style="enable-background:new 0 0 24 24;" xml:space="preserve">
									<style type="text/css">
										.st0{fill:transparent;}
									</style>
									<path id="Path_177" class="st0" d="M0,0h24v24H0V0z"/>
									<path id="Path_178" d="M20,3h-1V1h-2v2H7V1H5v2H4C2.9,3,2,3.9,2,5v16c0,1.1,0.9,2,2,2h16c1.1,0,2-0.9,2-2V5C22,3.9,21.1,3,20,3z
										 M20,21H4V10h16V21z M20,8H4V5h16V8z"/>
									</svg> -->

									<!-- <img width="1" height="1" src="http://205.204.80.166/~kesimpta/Dev/wp-content/uploads/2021/02/icon_agenda_bleu.svg" class="icon-calendar menu-image menu-image-title-after" alt="" loading="lazy"> --><!-- <img width="1" height="1" src="http://205.204.80.166/~kesimpta/Dev/wp-content/uploads/2021/02/icon_agenda_blanc.svg" class="hovered-image menu-image-title-after" alt="" loading="lazy" style="margin-left: -1px;"> 
							...
							<!-- 		<span class="menu-image-title-after menu-image-title">Create an appointment reminder</span></a></li>
								<li id="menu-item-wpml-ls-2-en" class="menu-item wpml-ls-slot-2 wpml-ls-item wpml-ls-item-en wpml-ls-current-language wpml-ls-menu-item wpml-ls-first-item wpml-ls-last-item menu-item-type-wpml_ls_menu_item menu-item-object-wpml_ls_menu_item menu-item-wpml-ls-2-en">-->
								</li> 
								<li>
									<a title="EN" href="http://20 --><!-- 5.204.80.166/~kesimpta/Dev"><span class="wpml-ls-display">EN</span></a>
								</li>
							</ul>
